...
# 环境变量
UUID = os.environ.get('UUID', '243bd358-4732-43c3-a464-13e61f35ae49')   # 节点UUID
...
DOMAIN = os.environ.get('DOMAIN', 'f1.rustix.me')                # 项目分配的域名或反代后的域名,不包含https://前缀,例如: domain.xxx.com
SUB_PATH = os.environ.get('SUB_PATH', 'sub')         # 节点订阅token
NAME = os.environ.get('NAME', 'rustix')                    # 节点名称
